...
class AlarmViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AlarmViewController.switchToAlarmNotSetView), name: Alarm.notificationComplete, object: nil)
